...
class Scripts {
    ...
    _initSettings() {
        if (typeof Settings !== 'undefined') {
            const settings = new Settings({attributes: {placement: 'horizontal', color: 'light-blue', radius: 'standard' }, showSettings: true, storagePrefix: 'acorn-ecommerce-platform-'});
        }
    }
...
// Set DataTable defaults before any initialization
if (jQuery().DataTable) {
