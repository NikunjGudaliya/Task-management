...
class Nav {
  ...
  _init() {
    ...
    this.menuInsertTarget = this.menuContainer
      ? this.menuContainer.querySelector('.menu-scroll-track') || this.menuContainer
      : null;
  ...
  _addVerticalMenu() {
    ...
    this.menuInsertTarget.insertAdjacentElement('beforeend', this.menuVertical);
  ...
  _addHorizontalMenu() {
    ...
    this.menuInsertTarget.insertAdjacentElement('beforeend', this.menuHorizontal);
    document.querySelector('#menu').classList.add('show');
  ...
  _initHorizontalMenu() {
    ...
    this._initMainMenuDropdownsFixed();
  }

  // Popper fixed strategy so dropdowns escape .menu-scroll-track overflow-x without clipping.
  _initMainMenuDropdownsFixed() {
    document.querySelectorAll('#menu > li > a[data-bs-toggle="dropdown"]').forEach((toggle) => {
